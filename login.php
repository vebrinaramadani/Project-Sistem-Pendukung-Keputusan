	...
	<nav class="navbar navbar-inverse navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" >Aplikasi Pemilihan Sekolah Menggunakan Metode SAW (Simple Additive Weighting)</a>
		</div>
...
<!--     <div class="container">
    <img width=300 height=100 src='images/school.png' />

	</div> -->
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-6 col-md-8">
				<img width="900" height="600" src="images/school.png">
			</div>
  			<div class="col-xs-6 col-md-4">
				  ...
				  <button type="submit" class="btn btn-primary">Login</button> <br>
					<br>
					<p>Anda Pengguna? <a href="home.php"> Silahkan Masuk</a> </p>
				</form>
		  	</div>
  			</div>
		</div>
