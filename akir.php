	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav">
			...
			<li><a href="akir.php">Hasil Alternatif</a></li>
		  </ul>
...
?>
	...
	<div>
	  ...
	  <ul class="nav nav-tabs" role="tablist">
	    <li role="presentation" class="active"><a href="#rangking" aria-controls="rangking" role="tab" data-toggle="tab">Hasil Akhir</a></li>
	  ...
	  <div class="tab-content">
			...
			<table width="100%" id="table-akhir" class="table table-striped table-bordered">
		        <thead>
		            <tr>
		                ...
		                <th rowspan="2" style="vertical-align: middle" class="text-center">Hasil Alternatif</th>
		            </tr>
		            <tr>
		            <!-- <?php
		...
		?>
		            <tr class="text-center">
		                <th class="text-center"><?php echo $row1['nama_alternatif'] ?></th>
		                <?php
